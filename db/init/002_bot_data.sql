...
INSERT INTO code_review_trends.bots (id, name, product_id, website, description, brand_color, avatar_url) VALUES
    ...
    ('copilot', 'GitHub Copilot', 'copilot', 'https://github.com/features/copilot', 'GitHub''s native AI pair programmer. Provides inline code review suggestions directly in the PR UI.', '#1f6feb', 'https://avatars.githubusercontent.com/in/946600?v=4'),
