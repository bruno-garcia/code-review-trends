...
INSERT INTO code_review_trends.products (id, name, website, description, docs_url, brand_color, avatar_url) VALUES
    ...
    ('copilot', 'GitHub Copilot', 'https://github.com/features/copilot', 'GitHub''s native AI pair programmer. Provides inline code review suggestions directly in the GitHub pull request UI. Part of the Copilot suite that includes code completion, chat, and workspace features.', 'https://docs.github.com/en/copilot', '#e5e7eb', 'https://avatars.githubusercontent.com/in/946600?v=4'),
    ('codescene', 'CodeScene', 'https://codescene.com', 'Behavioral code analysis platform. Identifies code health issues, complexity hotspots, and technical debt trends. Combines static analysis with version control history to prioritize refactoring efforts.', 'https://codescene.io/docs', '#5f72ee', 'https://avatars.githubusercontent.com/u/38929568?v=4'),
    ...
    ('sentry', 'Sentry', 'https://sentry.io', 'Application monitoring and error tracking platform. GitHub integration links errors to PRs, provides AI root cause analysis via Seer, and Codecov AI adds test coverage insights to reviews.', 'https://docs.sentry.io', '#9589c4', 'https://avatars.githubusercontent.com/u/1396951?v=4'),
...
INSERT INTO code_review_trends.bots (id, name, product_id, website, description, brand_color, avatar_url) VALUES
    ...
    ('copilot', 'GitHub Copilot', 'copilot', 'https://github.com/features/copilot', 'GitHub''s native AI pair programmer. Provides inline code review suggestions directly in the PR UI.', '#e5e7eb', 'https://avatars.githubusercontent.com/in/946600?v=4'),
    ('codescene', 'CodeScene', 'codescene', 'https://codescene.com', 'Behavioral code analysis platform. Identifies code health, complexity hotspots, and technical debt.', '#5f72ee', 'https://avatars.githubusercontent.com/u/38929568?v=4'),
